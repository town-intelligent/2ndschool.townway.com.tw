  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li id="index" class="nav-item">
        <a id="about_nav" class="nav-link fw-bold" href="/index.html">關於 Second School </a>
      </li>
...
const str_footer_backup = `    <footer class="bg-footer">
<div class="container-fluid">
  <div class="row justify-content-center pt-4">
    <div class="col-lg-9 d-none d-lg-block">
      <div class="h-100 d-flex align-items-center justify-content-center justify-content-lg-start mt-2 mt-lg-0 fz-18">
        <p class="mr-3 mb-0"><a id="about_fot1" href="/index.html" class="text-dark nav-link px-0 fw-bold">關於 Second School</a></p>
    ...
    <div class="col-lg-3 mb-4 mb-lg-0">
      <div class="d-flex h-100 align-items-center justify-content-center justify-content-lg-end">
        <div>
          ...
          <a class="text-decoration-none" href="https://www.facebook.com/profile.php?id=100063976478092" target="_blank">
    ...
    <div class="d-flex flex-wrap justify-content-center d-lg-none fz-18">
      <p class="mr-3 mb-0"><a id="about_fot2" class="text-dark nav-link px-0 fw-bold" href="/index.html">關於 Second School</a></p>
  ...
  <div class="py-4">
    <div class="text-center">
      <p id="copyright" class="fw-bold mb-0">Copyright © 2024 SECOND SCHOOL</p>
    </div>
  </div>
</div>
</footer>`
